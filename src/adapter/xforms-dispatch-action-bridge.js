...
(() => {
  ...
  class XFormsDispatchActionBridge {
    static create({ host } = {}) {
      ...
      if (!root.XFormsActionDeclarationSource?.collect) throw new DispatchActionError("action-declaration-source-unavailable", "Load xforms-action-declaration-source.js before xforms-dispatch-action-bridge.js.");
